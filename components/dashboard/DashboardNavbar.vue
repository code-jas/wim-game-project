<template>
  <div class="flex  items-center justify-between w-10/12 h-[98px] bg-white px-9  mb-16 rounded-[15px] drop-shadow-lg dark:bg-dk-inp-b-alt">
      <h1 class="font-franklin text-5xl text-lt-t-prim dark:text-violet-l">Dashboard</h1>
      <div class="flex items-center justify-between gap-x-7">
        ...
        @click="toggleDarkMode"
         ...
         <button  @click="$emit('showModal')" type="button" class="w-[45px] h-[45px] flex items-center justify-center bg-violet-l-alt rounded-full   hover:scale-110 transition duration-300 dark:bg-dk-inp-alt">
