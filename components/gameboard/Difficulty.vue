  ...
  >
    ...
    >
      ...
      <div class="flex justify-center gap-x-3">
        ...
        >
          <i
            class="uil uil-question-circle text-blue text-4xl rounded-full dark:text-dk-t-prim"
          ></i>
        </button>
      </div>
    </div>
    <div
      class="flex items-center justify-center flex-col py max-w-screen-2xl mx-auto"
    >
      <div
        class="text-center font-black text-6xl text-lt-t-prim-alt dark:text-violet-l lg:text-4xl xl:text-5xl"
      >
      ...
      <div class="flex flex-wrap justify-center my-16">
        ...
        >
          <div
            :class="[
              'absolute w-full h-full bg-blob-diff bg-no-repeat bg-center transition duration-300 ease-in-out',
              {
                'scale-225 hover:scale-110': selectedDifficulty !== index,
                'scale-110': selectedDifficulty === index,
              },
            ]"
          ></div>
          <h1>{{ difficulty }}</h1>
      ...
      <div class="flex justify-center">
        <button
          class="bg-blue-v w-[476px] h-[70px] sm:w-[200px] md:w-[300px] xl:w-[400px] 2xl:w-[456px] text-lt-inp font-franklin text-4xl rounded-[15px] active:transform active:translate-y-1 transition duration-300"
          @click="nextClicked"
        >
          Next
        </button>
