  ...
  <div class="bg-violet-l-alt h-screen py-20 flex flex-col items-center dark:bg-dk-inp-b">
    ...
    <div class="flex items-center justify-center flex-col py max-w-screen-2xl mx-auto">
      ...
      <div class="flex justify-center">
        <button class="bg-blue-v w-[476px] h-[70px] sm:w-[200px] md:w-[300px] xl:w-[400px] 2xl:w-[456px] text-lt-inp font-franklin text-4xl rounded-[15px]" @click="nextClicked">Next</button>
      </div>
    </div>
